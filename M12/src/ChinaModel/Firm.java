...
public class Firm implements Steppable{
	...
	Firm(int srr95, int srr96, int srr97, int srr98, int srr99, int srr00,
			...
			int ruralincpc95, int ruralincpc96, int ruralincpc97, int ruralincpc98, int ruralincpc99, 
			int urbanincpc95, int urbanincpc96, int urbanincpc97, int urbanincpc98, int urbanincpc99,
		...
		rural_incpc1996 = ruralincpc96;
		rural_incpc1997 = ruralincpc97;
		rural_incpc1998 = ruralincpc98;
		rural_incpc1999 = ruralincpc99;
		...
		urban_incpc1996 = urbanincpc96;
		urban_incpc1997 = urbanincpc97;
		urban_incpc1998 = urbanincpc98;
		urban_incpc1999 = urbanincpc99;
	...
	public int sizeOfNuclearFamily = 0;
	...
	public void updateData(CMModel model){
		if (currentYear != model.date.getYear()){
			currentFdi = fdi[(model.date.getYear() - 1995)];
		}
